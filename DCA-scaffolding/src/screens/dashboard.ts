...
class dashboard extends HTMLElement {
	...
	render() {
		...
		title.innerText = 'Añadir un evento';
		this.shadowRoot?.appendChild(title);

		const imagevinilo = this.ownerDocument.createElement('input');
		imagevinilo.placeholder = 'Url Imagen';
		...
		albumvinilo.placeholder = 'Título';
		...
		artistavinilo.placeholder = 'Fecha y hora';
		...
		preciovinilo.placeholder = 'Ubicación';
		...
		stockvinilo.placeholder = 'Número de asistentes';
